...
const Article = () => {
    return(
        <article className="article">
            ...
            <img src ={process.env.PUBLIC_URL + "/images/nutricion.JPG"} className="article__photo" alt="mujer comiendo sentada en la base a la heladera"/>
                <figcaption className="article__figcaption">Los expertos en nutrición desaconsejan el consumo de calorías que no aporten un valor nutricional de calidad al organismo(Shutterstock) </figcaption>
            ...
            <a tittle="pagina de Adidas" href="adidas.com.ar/yoga"><img src ={process.env.PUBLIC_URL + "/images/adidas-banner.jpg"} className="article__banner" alt="mujer comiendo sentada en la base a la heladera"/></a>
        </article>
    )
}
